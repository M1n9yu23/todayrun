...
internal fun heartRatePermission(sdkInt: Int = Build.VERSION.SDK_INT): String = heartRatePermissionFor(sdkInt)

internal fun isAskable(state: PermissionState): Boolean = state == PermissionState.NOT_DETERMINED || state == PermissionState.DENIED
